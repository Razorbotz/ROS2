...
void victor1Callback(const messages::msg::VictorOut::SharedPtr victorOut){
    //RCLCPP_INFO(nodeHandle->get_logger(), "victor callback");
    send("Victor", victorOut);
}
...
int main(int argc, char **argv){
    ...
    auto victor1Subscriber = nodeHandle->create_subscription<messages::msg::VictorOut>("victor_7_info",1,victor1Callback);
