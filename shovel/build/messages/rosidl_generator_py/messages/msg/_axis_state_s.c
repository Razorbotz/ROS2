...
bool messages__msg__axis_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("messages.msg._axis_state.AxisState", full_classname_dest, 34) == 0);
  }
  ...
  {  // axis
    ...
    ros_message->axis = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // state
...
PyObject * messages__msg__axis_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // axis
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->axis);
    {
