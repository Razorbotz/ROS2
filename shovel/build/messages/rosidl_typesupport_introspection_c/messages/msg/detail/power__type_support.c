...
#include <stddef.h>
#include "messages/msg/detail/power__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Power__rosidl_typesupport_introspection_c__Power_message_member_array[18] = {
  {
    "voltage",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(messages__msg__Power, temperature),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
